    ...
    >
     ...
     <div className="flex w-[768px] items-center h-[202px] lg:h-[96px] px-4 py-3 flex-wrap cursor-pointer overflow-hidden overflow-y-clip mx-auto">
      ...
      <div className="flex pl-[5rem] pt-6">
        <Link href="/">
        <img src="/assets/images/logo.svg" width={120} height={20} alt='logo'/>
        </Link>
      </div>
      ...
      <div className="flex pr-[5rem] place-content-center pt-6 gap-3 ">
        ...
        >
          <img 
            src="/assets/images/searchIcon2.svg"
            width={39} 
            height={40} 
            alt='search'
          />
        ...
        >
          <img src="/assets/images/menuIcon.svg" width={60} height={40} alt="menu"/>
        </button>
      </div>
